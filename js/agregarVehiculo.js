                                ...
                                if (result.length == 0) {
                                    ...
                                    vehiculo2.con.query("select * from vehiculoresidente where residente=?", [rut], function (error, result) {
                                        if (largo1 == result.length) {
                                            ...
                                            vehiculo2.con.query("SELECT estacionamientoresidente.*,vehiculoresidente.patente from estacionamientoresidente left join vehiculoresidente on estacionamientoresidente.numero=vehiculoresidente.numeroEstacionamiento where estacionamientoresidente.residente=?", [rut], function (error, result) {
                                                estacionamiento.innerHTML = ""
                    ...
                    this.con.connect(function () {
                        vehiculo2.con.query("select * from vehiculoresidente where patente=?", [patente], function (error, result) {
                            if (result.length != 0) {
                                ...
                                try {
                                    vehiculo2.con.query("insert into vehiculoresidente (patente,marca,modelo,numeroEstacionamiento,residente) values(?,?,?,?,?)", [patente, marca, modelo, estacionamiento, rut], function (error, result) {
